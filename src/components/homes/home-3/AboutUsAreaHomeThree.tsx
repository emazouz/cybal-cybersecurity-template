          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
              ...
              <div className="abmv_list">
                <ul>
                  <li><img src="assets/img/check.png" alt="image-here" /> Secure user access to data and applications system.</li>
                  <li><img src="assets/img/check.png" alt="image-here" /> A security-first approach to protect customer workloads.</li>
                  <li><img src="assets/img/check.png" alt="image-here" /> Extend security and risk mitigation capabilities now.</li>
                  <li><img src="assets/img/check.png" alt="image-here" /> Safeguard your most valuable asset—data.</li>
                </ul>
              </div>
            ...
            <div className="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
              <div className="ab_img ai_top">
                ...
                <img src="assets/img/about5.png" className="img-fluid" alt="image" />
              </div>
            </div>
          </div>
        </div>
...
export default AboutUsAreaHomeThree;